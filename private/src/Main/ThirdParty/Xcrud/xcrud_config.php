<?php
namespace Main\ThirdParty\Xcrud;
...
class Xcrud_config
{
    ...
    public static $theme; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
    public static $language; // sets default localization
    public static $dbencoding; // Your database encoding, default is 'utf8'. Do not change, if not sure.
    public static $db_time_zone; // database time zone, if you want use system default - leave empty.
    public static $mbencoding; // Your mb_string encoding, default is 'utf-8'. Do not change, if not sure.
    ...
    // alert settings
    public static $email_from = 'aommiez@gmail.com'; // email from address
    public static $email_from_name = 'OLO FW xCRUD Data Management System'; // email from name
